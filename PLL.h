...
#define PSYSDIV 4 // Changed from 3 to 4


// bus frequency is 110MHz/(PSYSDIV+1) = 110MHz/(4+1) = 22 MHz

// Initially: 480MHz/(PSYSDIV+1) = 480MHz/(3+1) = 120 MHz

// To change bus frequency to 22MHz, had to change 480MHz to 110MHz (Found by isolating for 22MHz and solving for replacement 480MHz value)
// Had to change PSYDIV since using 3 gave a decimal MINT value
