...
// bus frequency is 110MHz/(PSYSDIV+1) = 110MHz/(4+1) = 22 MHz
...
#define FXTAL 25000000  // fixed, this crystal is soldered to the Connected Launchpad (Crystal frequency)
#define Q            0
...
// CHANGED THIS USING MINT FORMULA (system speed)
#define MINT        22  // SYSCLK = ((fsrc / (Q+1)(N+1))*MINT)/(PSYDIV+1)
												// 22,000,000 = (25,000,000/(4+1)(0+1)*22)/(4 + 1))
												// PSYSDIV = 4 instead of 3 since fractional answer if not
