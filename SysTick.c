...
// The delay parameter is in units of the core clock. (units of 45.4545 nsec for 22 MHz clock)
...
// Time delay using busy wait.
// This assumes 22 MHz system clock.
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(22000);  // wait 1ms (assumes 22 MHz clock)
  }
}
